            ...
            <div className="deck-outside">
                    ...
                    {selectedCards.map((card, index) => (
                        <button key={index} className="card-wrap">
                            <span className="card-close" onClick={(e) => {
                                // e.stopPropagation();
                                onRemoveCard(index);
                            }}><Image src="https://ekadon-bucket.s3.ap-northeast-1.amazonaws.com/icons/close.svg" width={15} height={15} alt="close" /></span>
                ...
                <div className="deck-bottom">
                    <button className="sound">
                        <Image src="https://ekadon-bucket.s3.ap-northeast-1.amazonaws.com/icons/sound.svg" width={50} height={50} alt="サウンド" />
                    </button>
                    <button className="zoom" onClick={() => setIsFullscreen(!isFullscreen)}>
                        <Image src={
                            isFullscreen
                                ? "https://ekadon-bucket.s3.ap-northeast-1.amazonaws.com/icons/zoom-out.svg"
                                : "https://ekadon-bucket.s3.ap-northeast-1.amazonaws.com/icons/zoom-up.svg"
                        } width={50} height={50}
