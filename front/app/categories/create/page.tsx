...
export default function CreateCategoryPage() {
    ...
    const [previewUrl, setPreviewUrl] = useState<string>("https://ekadon-bucket.s3.ap-northeast-1.amazonaws.com/icons/select-img.svg"); // 選択した画像を表示するため
                ...
                <div onSubmit={handleSubmit} className="content_wrap">
                    <form className="create-category">
                        ...
                        <label className="create-wrap select-cards">
                            <img src="https://ekadon-bucket.s3.ap-northeast-1.amazonaws.com/icons/select-cards.svg" alt="カード選択" className="select-cards-img" />
