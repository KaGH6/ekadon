                ...
                <div className="guide-wrapper">
                    ...
                    <div className="guide" aria-labelledby="sec-deck">
                        <h2 id="sec-deck" className="section__title">
                            <span id="guide-4" className="badge">4</span> マイリスト
                        </h2>
                        ...
                        <article className="card-row">
                            ...
                            <div className="card">
                                <div className="card__head">
                                    <span className="step">1</span>
                                    <h3 className="card__title">マイリストに保存</h3>
                                </div>
                                <div className="mock">
                                    <div className="mock__screen">
                                        <div className="mock__figure">
                            ...
                            <div className="card">
                                <div className="card__head">
                                    <span className="step">2</span>
                                    <h3 className="card__title">保存したマイリストの編集</h3>
                                </div>
                                <div className="mock">
                                    <div className="mock__screen">
                                        <div className="mock__figure">
                            ...
                            <div className="card">
                                <div className="card__head">
                                    <span className="step">3</span>
                                    <h3 className="card__title">編集したマイリストの保存</h3>
                                </div>
                                <div className="mock">
                                    <div className="mock__screen">
                                        <div className="mock__figure">
                                ...
                                <p className="card__desc">
                                    ① 2.「保存したマイリストの編集」の③でデッキ保存ボタンを押下後、ウィンドウが表示されます。
                                </p>
                                <p className="card__desc">
                            ...
                            <div className="card">
                                <div className="card__head">
                                    <span className="step">4</span>
                                    <h3 className="card__title">保存したマイリストの削除</h3>
                                </div>
                                <div className="mock">
                                    <div className="mock__screen">
                                        <div className="mock__figure">
