                ...
                <div className="content_wrap">
                    ...
                    <div className="home-list">
                        <Link href={`/categories`} className="home-content">
                            <Image src="http://127.0.0.1:8000/storage/images/icons/checklist.svg" alt="チェックリスト" className="home-list-img" width={70} height={70} />
                            <h3>チェックリスト</h3>
                        </Link>
                        <Link href={`/categories`} className="home-content">
                            <Image src="http://127.0.0.1:8000/storage/images/icons/card-category.svg" alt="カテゴリー" className="home-list-img" width={70} height={70} />
                            <h3>カテゴリー</h3>
                        </Link>
                    </div>
                </div>
